...
test: build
	docker run --rm -e DISABLE_MEMCACHE=1 --volume $(shell pwd)/htmlcov:/app/htmlcov opentopodata pytest --ignore=data --ignore=scripts --cov=opentopodata --cov-report html
